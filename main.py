...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_1.addWidget(self.b_minus)
        self.b_float = QPushButton(".", self)
        self.hbox_0.addWidget(self.b_float)
        ...
        self.hbox_0.addWidget(self.b_0)
        self.b_multiply = QPushButton("*", self)
        self.hbox_2.addWidget(self.b_multiply)
        self.b_divide = QPushButton("/", self)
        self.hbox_2.addWidget(self.b_divide)
        self.b_result = QPushButton("=", self)
        self.hbox_0.addWidget(self.b_result)
        self.b_clear = QPushButton("                     Clear                    ", self)
        self.hbox_3.addWidget(self.b_clear)
        self.b_None = QPushButton("                                                  ", self)
        self.hbox_0.addWidget(self.b_None)
    ...
    def _operation(self, op):
        self.num_CHECK1 = self.input.text()
        if self.num_CHECK1 != "":
            self.num_1 = float(self.num_CHECK1)
            self.op = op
            self.input.setText("")
        else:
            self.input.setText("ERROR# No input")

    def _result(self):
        self.num_CHECK2 = self.input.text()
        if self.num_CHECK2 != "":
            self.num_2 = float(self.num_CHECK2)
            if self.op == "+":
                ...
                if self.num_2 != 0:
                    ...
                    self.input.setText("ERROR# Divided by zero ")
        else:
            self.input.setText("ERROR# No input")
